<x-ui.sccr-card transparent wire:key="inv-master-lokasi-delete-outstanding">

    {{-- HEADER --}}
    <div class="relative px-8 py-6 bg-red-600/80 rounded-b-3xl shadow overflow-hidden">
        <div class="flex justify-between items-start">
            <div>
                <h1 class="text-3xl font-bold text-white">Outstanding Delete — Master Lokasi</h1>
