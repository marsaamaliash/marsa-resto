<div class="p-6">
    @if ($kategori)
        ...
        <div class="flex gap-3 pt-4 border-t mt-4">
            ...
            @endif
            <button type="button" wire:click="$dispatch('kategori-overlay-close')"
