<div class="p-6">
    @if ($vendor)
        <h2 class="text-xl font-bold mb-4">Detail Vendor</h2>
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-xs font-medium text-gray-500">Kode Vendor</label>
                    <p class="text-sm font-mono">{{ $vendor->code }}</p>
                </div>
            </div>

            <div>
                <label class="block text-xs font-medium text-gray-500">Nama Vendor</label>
            ...
            @if ($vendor->status === 'rejected' && $vendor->rejection_reason)
                <div>
                    <label class="block text-xs font-medium text-gray-500">Alasan Reject</label>
