<div class="p-6">
    <h2 class="text-xl font-bold mb-4">{{ $outputId ? 'Edit Output' : 'Tambah Output Resep' }}</h2>

    <form wire:submit.prevent="save" class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Tipe Output <span class="text-red-500">*</span></label>
