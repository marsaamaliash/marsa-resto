<div class="p-6">
    <h2 class="text-xl font-bold mb-4">{{ $componentId ? 'Edit Component BOM' : 'Add Component BOM' }}</h2>

    <form wire:submit.prevent="save" class="space-y-4">
        <div class="grid grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Type Component <span class="text-red-500">*</span></label>
                <select wire:model.live="componentKind"
                    class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    <option value="item">Item (Bahan Baku)</option>
                    <option value="recipe">Sub-Recipe (Nested BOM)</option>
                </select>
                @error('componentKind')
        ...
        @if ($componentKind === 'item')
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Raw Material Item <span class="text-red-500">*</span></label>
        ...
        @else
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Sub-Recipe <span class="text-red-500">*</span></label>
                ...
                <p class="text-xs text-amber-600 mt-1">
                    &#9888; Sub-Recipe akan menyebabkan nested BOM. Pastikan No circular reference.
                </p>
            </div>
        @endif
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="flex flex-col justify-end gap-4 pt-5">
                <div class="flex items-center gap-2">
                    ...
                    <label for="comp_is_optional" class="text-sm text-gray-700">Optional</label>
                </div>
