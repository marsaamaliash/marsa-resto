<div>
    <div class="relative px-8 py-6 bg-yellow-500/60 rounded-b-3xl shadow-lg overflow-hidden">
        <div class="flex justify-between items-start">
            <div>
                <h1 class="text-3xl md:text-4xl font-bold mb-2">Purchase Order (PO)</h1>
                <p class="text-lg text-gray-800">Halaman Purchase Order</p>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-10">
        <div class="flex items-center justify-center h-64">
            <p class="text-xl text-gray-500">Halaman Purchase Order (PO) — dalam pengembangan</p>
        </div>
    </div>
</div>
