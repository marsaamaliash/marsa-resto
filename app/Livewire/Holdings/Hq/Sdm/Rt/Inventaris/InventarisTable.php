...
use App\Models\Holdings\Hq\Sdm\Rt\Inventaris\{
    InventarisList,      // VIEW v_inventaris_lengkap (sudah filter deleted_at & lifecycle_status)
    Inv_Lokasi_List,     // VIEW v_inv_lokasi_list (sudah join holdings)
    Inv_Ruangan_List     // VIEW v_inv_ruangan_list (sudah join holdings)
};

use App\Actions\Inventaris\RequestDeleteInventarisAction;
...
class InventarisTable extends Component
{
    ...
    public function mount(): void
    {
        $this->breadcrumbs = [
            ...
            ['label' => 'Rumah Tangga', 'route' => 'dashboard.rt', 'color' => 'text-gray-800'],
            ['label' => 'Inventaris', 'color' => 'text-gray-900 font-semibold'],
        ];
    ...
    public function exportSelected()
    {
        ...
        $data = InventarisList::whereIn('kode_label', $ids)->get();
    ...
    public function render()
    {
        ...
        return view('livewire.holdings.hq.sdm.rt.inventaris.inventaris-table', [
